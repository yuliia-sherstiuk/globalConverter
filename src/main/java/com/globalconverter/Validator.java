...
public class Validator {
    ...
    // Validates if the input is a valid base for conversion
    ...
    // Validates if the Vigenère key is valid (only letters)
    public static boolean isValidVigenereKey(String key) {
        return key != null && key.matches("[a-zA-Z]+");
    }
    
    // Validates if the XOR key is valid (non-empty string)
    public static boolean isValidXORKey(String key) {
    ...
    public static String encryptXOR(String text, String key) {
        return Cipher.xorCipher(text, key);
    }
    ...
    public static String encryptSubstitution(String text, String key) {
        return Cipher.substitutionEncrypt(text, key);
    }
    ...
    public static String decryptSubstitution(String text, String key) {
        return Cipher.substitutionDecrypt(text, key);
    }
}
